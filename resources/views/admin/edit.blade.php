@extends('admin.main')
@section('content')
    <form action="{{ url('dashboard/' . $ormada->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="px-8 pt-5 pb-10 block md:grid md:grid-cols-2 md:gap-5 w-full">
                            <div class="block">
                                ...
                                <input id="name" name="name" type="text" placeholder="Nama Ormada"
                                    class="rounded-lg border border-green-1 p-2 w-full" value="{{ $ormada->name }}" />
                            </div>
                            ...
                            <div class="block
                                ...
                                <input id="regional" name="regional" type="text" placeholder="Daerah asal ormada"
                                    class="rounded-lg border border-green-1 p-2 w-full" value="{{ $ormada->regional }}" />
                            </div>
                            ...
                            <div class="block md:mt-0 mt-5">
                                ...
                                <input type="file" id="logo" name="logo"
                                    ...
                                    value="{{ asset('storage/images/' . $ormada->logo) }}">
                            </div>
                            ...
                            <div class="block md:mt-0 mt-5">
                                ...
                                <input id="instagram" name="instagram" type="text"
                                    ...
                                    class="rounded-lg border border-green-1 p-2 w-full" value="{{ $ormada->instagram }}" />
                            </div>

                            <div class="block md:mt-0 mt-5">
                                <p class="font-semibold">Whatsapp*</p>
                                <input id="whatsapp" name="whatsapp" type="text" placeholder="Link whatsapp ormada"
                                    class="rounded-lg border border-green-1 p-2 w-full" value="{{ $ormada->whatsapp }}" />
                            </div>
